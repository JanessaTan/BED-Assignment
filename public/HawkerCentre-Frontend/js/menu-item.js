document.addEventListener("DOMContentLoaded", function initialiseMenu() {
  ...
  document.getElementById("stallBadges").innerHTML = `<span class="badge ${HC.hygieneBadgeClass(stall.hygiene)}">${HC.hygieneText(stall.hygiene)}</span><span class="badge badge-info">${HC.escapeHtml(centre.name)}</span>`;
