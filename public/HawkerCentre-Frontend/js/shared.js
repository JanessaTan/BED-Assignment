  ...
  function requireRole(allowedRoles) {
    ...
    if (!allowed.includes(role)) {
      ...
      window.setTimeout(function redirectForRole() {
        window.location.replace(role === "vendor" ? "vendor-dashboard.html" : "home.html");
      }, 250);
      return false;
    }
    return true;
    ...
    headerTarget.innerHTML = `
      ...
      <header class="site-header">
        <div class="header-inner">
          <a class="brand" href="${role === "vendor" ? "vendor-dashboard.html" : "home.html"}" aria-label="HawkerHub home">
      ...
      <footer class="site-footer">
        <div class="footer-inner">
          ...
          <section>
            <h3>Quick links</h3>
            <ul>
              <li><a href="browse-hawker-centres.html">Browse centres</a></li>
              <li><a href="crowd-level.html">Check crowd levels</a></li>
              <li><a href="promotion.html">View promotions</a></li>
            </ul>
          </section>
          <section>
            <h3>Project</h3>
